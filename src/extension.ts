...
export function activate(context: vscode.ExtensionContext) {
	...
	outputChannel = vscode.window.createOutputChannel("Claude Dev2")
	...
	const openClaudeDevInNewTab = async () => {
		...
		const panel = vscode.window.createWebviewPanel(ClaudeDevProvider.tabPanelId, "Claude Dev2", targetCol, {
			enableScripts: true,
